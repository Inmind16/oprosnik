window.addEventListener("load", function(){
    ...
    let rec = function(){
        if(form2.question4.value == 5){
            recommendations += " Куріння призводить до хвороб, що впливає на серце і легені, добре що ви не курите. Алкоголь також дуже негативно впливаэ на здоров'я, вживати його потрібно як найменше." + "<br>" + "<br>";
        }
        else if(form2.question4.value < 5){
            recommendations += " Куріння призводить до хвороб, що впливають на серце і легені, рекомендуємо відмовитися від цієї негативної звички. Алкоголь також дуже негативно впливаэ на здоров'я, вживати його потрібно як найменше." + "<br>" + "<br>";
        }


        if(form2.question6.value > 4){
            recommendations += " Регулярне заняття спортом робить серце і судини людини більш витривалими." + "<br>";
        }
        else if(form2.question6.value <= 4){
            recommendations += " Вам потрібно більше займатись спортом. Регулярне заняття спортом робить серце і судини людини більш витривалими." + "<br>" + "<br>";
        }

        if(form2.question7.value == 5){
            recommendations += " Вживання цукру у великих кількостях погано впливає на  весь організм  і може привести появи цукрового діабету." + "<br>" + "<br>";
        }
        else if(form2.question7.value == 3){
            recommendations += " Вживання цукру у великих кількостях погано впливає на  весь організм  і може привести появи цукрового діабету. Рекомендуємо зменьшити його вживання" + "<br>" + "<br>";
        }
        else if(form2.question7.value == 2){
            recommendations += " Вживання цукру у великих кількостях погано впливає на  весь організм  і може привести появи цукрового діабету. Вам потрібно зменьшити його вживання" + "<br>" + "<br>";
        }


        if(form2.question8.value >= 3){
            recommendations += " Споживання фастфуду в нормі. Фастфуд дуже калорійний через високий вміст жирів і цукру. Велика кількість порожніх калорій веде до ожиріння і проблем травної системи." + "<br>" + "<br>";
        }
        else if(form2.question8.value < 3){
            recommendations += " Зменьшите споживання фастфуду. Фастфуд дуже калорійний через високий вміст жирів і цукру. Велика кількість порожніх калорій веде до ожиріння і проблем травної системи." + "<br>" + "<br>";
        }


        if(form2.question9.value == 5){
            recommendations += " Вживання в їжу надмірної кількості солі провокує зміни імунної системи в кишечнику, які тягнуть за собою деградацію когнітивних функцій людини. Підвищений  рівень стресу впливає на всі системи організму і може призвести до поганих наслідків." + "<br>" + "<br>";
        }
        else if(form2.question9.value < 5){
            recommendations += " Вживання в їжу надмірної кількості солі провокує зміни імунної системи в кишечнику, які тягнуть за собою деградацію когнітивних функцій людини. Не додавайте її без потреби. Підвищений  рівень стресу впливає на всі системи організму і може призвести до поганих наслідків." + "<br>" + "<br>";
        }
        

        if(form2.question11.value == 5){
            recommendations += " Здоровий сон дуже важливий для нормального функціонування організму людини. Потрібно обов’язково проходити плановий огляд, так як це допоможе завчасно виявити деякі види  захворювання." + "<br>" + "<br>";
        }
        else if(form2.question11.value == 2){
            recommendations += " Спіть більше. Здоровий сон дуже важливий для нормального функціонування організму людини. Потрібно обов’язково проходити плановий огляд, так як це допоможе завчасно виявити деякі види  захворювання." + "<br>" + "<br>";
        }


        if(form2.question13.value >= 4){
            recommendations += " Щоденне споживання води в нормі. Без потрібної кількості води в організмі, він не зможе нормально функціонувати." + "<br>" + "<br>";
        }
        else if(form2.question13.value < 4){
            recommendations += " Пийте більше води. Без потрібної кількості води в організмі, він не зможе нормально функціонувати." + "<br>" + "<br>";
        }


        if(form2.question14.value >= 4){
            recommendations += " Фрукти і овочі містять в собі багато вітаміну С та інших не менш корисних речовин, їх потрібно їсти не меньше 400г в день." + "<br>" + "<br>" + "Після кожного часу роботи рекомендується робити десяти хвилинну перерву, яку зручно суміщати з провітрюванням. За будь-яких умов безперервна робота за комп’ютером для дорослої людини не повинна перевищувати двох годин" + "<br>" + "<br>";
        }
